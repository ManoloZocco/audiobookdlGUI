...
def main():
    ...
    # ...existing options from args.parse_arguments()...
    parser.add_argument("--gui", action="store_true", help="Avvia l'interfaccia grafica")
    options = parser.parse_args()
    if options.gui:
        # Avvia la GUI
        from .gui import AudiobookDownloaderGUI
        app = AudiobookDownloaderGUI()
        app.mainloop()
    else:
        # Esegui logica della CLI
        run_cli(options)
